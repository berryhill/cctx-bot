...
module.exports = {
    ...
    Trades_Opened: mongoose.model('Trades_Opened', openTradesSchema, 'open_trades'),
    Positions_Open: mongoose.model('Positions_Open', openPositionsSchema, 'open_positions'),
    Trades_Closed: mongoose.model('Trades_Closed', closedTradesSchema, 'closed_trades'),
